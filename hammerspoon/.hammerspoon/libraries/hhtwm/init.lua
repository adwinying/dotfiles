...
local createLayouts = require('libraries.hhtwm.layouts')
...
local getSpacesIdsTable = function()
  ...
  hs.fnutils.each(hs.screen.allScreens(), function(screen)
    ...
    local userSpaces = hs.fnutils.filter(spacesLayout[spaceUUID] or {}, function(spaceId)
...
local getScreenBySpaceId = function(spaceId)
  ...
  return hs.fnutils.find(hs.screen.allScreens(), function(screen)
    ...
    return hs.fnutils.contains(spacesLayout[spaceUUID] or {}, spaceId)
  end)
end
